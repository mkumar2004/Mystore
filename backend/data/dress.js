...
const dress = [
    {
      ...
      allcollection: "Business Casual",
      material: "Cotton",
      gender: "Men",
      images: [
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD4DnTSlSKF06hb_dMlI3bhwVRVJj0PFWj8A&s",
          altText: "Classic Oxford Button-Down Shirt Front View",
        },
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSS-2LDpBaT2RdUDT_8hq0U9aUQDbhR1dLXmg&s",
    ...
    },
    {
      ...
      allcollection: "Formal Wear",
      material: "Cotton Blend",
      gender: "Men",
      images: [
        {
          url: "https://api.thomasscott.in/media/mf_webp/webp/media/catalog/product/N/E/NEWTS1132_Black_14_1731668785.webp",
          altText: "Slim-Fit Stretch Shirt Front View",
        },
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCez26nQ7Fh3aR1du-ghZcR9EURIoM5ZgREg&s",
    ...
    },
    {
      ...
      allcollection: "Casual Wear",
      material: "Denim",
      gender: "Men",
      images: [
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl2w2fqX1eTt9dQWyk8-Jrn588oeOG8j_G1w&s",
          altText: "Casual Denim Shirt Front View",
        },
        {
          url: "https://reidandtaylor.in/cdn/shop/files/RT-225-Dark-Blue_1_9212c00d-81af-4f67-ae3c-0730b65d741c.jpg?v=1741178276",
    ...
    },
    {
      ...
      allcollection: "Vacation Wear",
      material: "Viscose",
      gender: "Men",
      images: [
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXdd6YIqBbWzRv-qCWedSMfO6rLAzR6AukpA&s",
          altText: "Printed Resort Shirt Front View",
        },
        {
          url: "https://m.media-amazon.com/images/I/81wYMWuwD9L._AC_UY1100_.jpg",
    ...
    },
    {
      ...
      sizes: ["S", "M", "L", "XL"],
      colors: ["White", "Gray"],
      allcollection: "Business Wear",
      material: "Cotton",
      gender: "Men",
      images: [
        {
          url: "https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcQA0f7h2cYooSGCiaETQGLLcLwbJeGNZB4SVl-vmabOUc1FBIcVyrSAX1VBeFPeLoP7rHKkqtTw1vWiQi0qpVP_dFpxUlaWKc1L3sq1696YE13NSXMLbo0&usqp=CAc",
          altText: "Slim-Fit Easy-Iron Shirt Front View",
        },
        {
          url: "https://images.hugoboss.com/is/image/boss/hbeu50512820_410_100?$re_fullPageZoom$&qlt=85&fit=crop,1&align=1,1&lastModified=1709119022000&wid=1200&hei=1818",
          altText: "Slim-Fit Easy-Iron Shirt Front View",
        },
      ],
      rating: 5,
    ...
    },
    {
      ...
      images: [
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0RM6IeBw1JYmnbcyhwxvFB7qnt3v6rFYzwQ&s",
          altText: "Polo T-Shirt Front View",
        },
        {
          url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTJ8fkPYOPnH23fujKUqIPQiaZihNr2VqEcQ&s",
    ...
    },
    {
      ...
      images: [
        ...
        {
          url: "https://veirdo.in/cdn/shop/files/ai_creative_0000_Layer_6.jpg?v=1736570574",
          altText: "Polo T-Shirt Back View",
        },
      ],
      rating: 4.6,
    ...
    },
    {
      ...
      allcollection: "Winter Essentials",
      material: "Cotton",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Casual Collection",
      material: "Cotton Blend",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      sizes: ["S", "M", "L", "XL"],
      colors: ["Olive", "Black"],
      allcollection: "Urban Collection",
      material: "Cotton",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Lounge Collection",
      material: "Fleece",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Denim Collection",
      material: "Denim",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Smart Casual Collection",
      material: "Cotton",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Activewear Collection",
      material: "Polyester",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Street Style Collection",
      material: "Cotton",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      sizes: ["M", "L", "XL"],
      colors: ["Black", "Navy"],
      allcollection: "Formal Collection",
      material: "Polyester",
      gender: "Men",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Spring Collection",
      material: "Polyester",
      gender: "Women",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Summer Collection",
    ...
    },
    {
      ...
      allcollection: "Loungewear Collection",
      material: "Cotton Blend",
      gender: "Women",
      images: [
        {
    ...
    },
    {
      ...
      sizes: ["S", "M", "L"],
      colors: ["Beige", "White"],
      allcollection: "Knits Collection",
      material: "Cotton Blend",
      gender: "Women",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Evening Collection",
      material: "Polyester",
      gender: "Women",
      images: [
        {
    ...
    },
    {
      ...
      sizes: ["S", "M", "L"],
      colors: ["Black", "White"],
      allcollection: "Lingerie-Inspired",
      material: "Silk Blend",
      gender: "Women",
      images: [
        {
    ...
    },
    {
      ...
      allcollection: "Office Collection",
      material: "Cotton",
      gender: "Women",
      images: [
        {
